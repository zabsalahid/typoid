...
namespace typoid.Utility
{
    ...
    public abstract class BaseService<T> where T : class, new()
    {
        ...
        public long Add(T entity)
        {
            ...
            if (columns.ToString() != string.Empty)
            {
                ...
                qry.Append(string.Format("INSERT INTO [{0}] ( {1} ) VALUES ( {2} ); SELECT last_insert_rowid();"
                    , GetTableName(entity.GetType().Name), columns, values));
        ...
        public void Update(T entity)
        {
            ...
            if (columns.ToString() != string.Empty)
            {
                ...
                qry.Append(string.Format("UPDATE [{0}] SET {1} WHERE {2};"
                    , GetTableName(entity.GetType().Name), columns, clause));
        ...
        public T GetById(object id)
        {
            ...
            {
                StringBuilder qry = new StringBuilder();
                qry.Append(string.Format("SELECT * FROM [{0}] WHERE {1}", GetTableName(entity.GetType().Name), clause));
        ...
        public void DeleteById(object id)
        {
            ...
            {
                StringBuilder qry = new StringBuilder();
                qry.Append(string.Format("DELETE FROM [{0}] WHERE {1}", GetTableName(entity.GetType().Name), clause));
                var _entities = Execute(qry.ToString());
            }
        }
        ...
        {
            T entity = new T();
            return ExecuteGet(string.Format("SELECT * FROM [{0}]", GetTableName(entity.GetType().Name)));
        }
        /// <summary>
